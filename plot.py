...
plt.title('Average Accuracy by Model', fontsize=24, fontweight='bold')
plt.ylabel('Average Accuracy (0-4 groups)', fontsize=18)
...
print(f"Saved: {filename}")
plt.close()
# Reset font parameters to default for other plots
plt.rcParams.update({
    'font.size': plt.rcParamsDefault['font.size'],
    'axes.titlesize': plt.rcParamsDefault['axes.titlesize'],
    'axes.labelsize': plt.rcParamsDefault['axes.labelsize'],
    'xtick.labelsize': plt.rcParamsDefault['xtick.labelsize'],
    'ytick.labelsize': plt.rcParamsDefault['ytick.labelsize'],
    'legend.fontsize': plt.rcParamsDefault['legend.fontsize']
})
